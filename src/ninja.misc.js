...
ninja.tab = {
    select: function (walletTab) {
        ...
        if (walletTab.className.indexOf("selected") == -1) {
            ...
            if (ninja.seeder.isStillSeeding == false || walletType == "setupwallet" || walletType == "brainwallet" || walletType == "detailwallet") {
            	walletTab.className += " selected";
            	document.getElementById("generate").style.display = "none";
                ninja.wallets[walletTab.getAttribute("id")].open();
            }
            else if (ninja.seeder.isStillSeeding == true && !(walletType == "setupwallet" || walletType == "brainwallet" || walletType == "detailwallet")) {
