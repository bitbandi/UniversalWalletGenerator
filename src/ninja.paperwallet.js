ninja.wallets.paperwallet = {
	...
	getImage: function (index) {
		if (ninja.wallets.paperwallet.imgs[index] == undefined) index = "btc";
		return ninja.wallets.paperwallet.imgs[index];
	},
	...
	templateArtisticHtml: function (i) {
		...
		if (ninja.wallets.paperwallet.encrypt) {
			...
			image = ninja.wallets.paperwallet.getImage(document.getElementById("setupaddresspresets").value)["encrypt"];
		}
		else {
			image = ninja.wallets.paperwallet.getImage(document.getElementById("setupaddresspresets").value)["normal"];
